...
<body>
	<main>
		<section class="container wrapper">
        	...
        	<p class="text-center">Create Your MOCR Account. Get progress & more</p>
        	<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
        		...
        		<div class="form-group">
        			<input type="submit" class="btn btn-block btn-outline-success" value="Submit" style="background-color:#E63946 ; color:#F1FAEE">
